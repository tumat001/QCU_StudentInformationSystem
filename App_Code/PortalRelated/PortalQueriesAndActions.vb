...
'1) A Form of backup
'   - Either thru another table in database (with methods to save to and write to backup, but never read directly from backup)
'   - Or an object that contains all accounts with passwords (as Map/Dictionary). This object will ask for a key to access the map/dictionary
...
Public Class PortalQueriesAndActions
    ...
    Friend Shared ReadOnly PORTAL_DATABASE_CONNECTION_STRING As String = "Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Mat\source\repos\OnlineViewingOfGrades\App_Data\PortalAccountDatabase.mdf;Integrated Security=True"
