Public Class SubjectGrade
    ...
    Private Sub New(ByVal studentNumber As String, ByVal code As String, ByVal description As String,
                    ...
                    ByVal professor As String, ByVal [class] As String, course As String)
    ...
    Class Builder
        ...
        Function Build() As SubjectGrade
            Return New SubjectGrade(StudentNumber, Code, Description, Units, Grade, Remarks, Professor, [Class], Course)
        End Function
