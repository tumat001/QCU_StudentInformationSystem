...
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:RequiredFieldValidator ID="PasswordRequiredValidator" runat="server" ErrorMessage="Field is required" Font-Bold="False" Font-Size="Small" ForeColor="Red" ControlToValidate="PasswordField" ValidationGroup="AddStudent"></asp:RequiredFieldValidator>
    <br />
    <asp:Label ID="ConfirmPasswordLabel" runat="server" Text="Confirm Password:"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox ID="ConfirmPasswordField" runat="server" TextMode="Password"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:RequiredFieldValidator ID="ConfirmPasswordRequiredValidator" runat="server" ErrorMessage="Field is required" Font-Bold="False" Font-Size="Small" ForeColor="Red" ControlToValidate="ConfirmPasswordField" ValidationGroup="AddStudent"></asp:RequiredFieldValidator>
    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox ID="EmailField" runat="server" Width="250px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;
