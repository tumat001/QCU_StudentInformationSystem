Public Class AdminHomePage_EditProfileContent
...
#Region "ChangePassword"
    ...
    Private Function IsCurrentPasswordCorrect(oldPassword As String) As Boolean
        Try
            ...
            Return PortalQueriesAndActions.AdminQueriesAndActions.IsPasswordOfAdminAccountEqualTo(user, oldPassword)
    ...
    Private Sub ChangePasswordOfSelf()
        ...
        Try
            ...
            actionAs.AdminAccountRelated.ChangePasswordOfAdminAccount(user, NewPasswordField.Text)
        Catch ex As Exception
